...
const int recVerTest     = 25;
const wxStringCharType* recVerStr = wxS("TFPD-0.0.9.25");
...
static void UpgradeTest0_0_9_15to0_0_9_16()
{
    char* query =
        "ALTER TABLE FamilyIndividual RENAME TO OldFamilyIndividual;\n"
        ...
        " (id, fam_id, ind_id, seq_child, seq_parent)"
        " SELECT id, fam_id, ind_id, sequence, 1"
        " FROM OldFamilyIndividual;\n"
        "DROP TABLE OldFamilyIndividual;\n"
    ;
    recDb::Begin();
    recDb::GetDb()->ExecuteUpdate( query );
    recVersion::Set( 0, 0, 9, 16 );
    recDb::Commit();
}
...
static void UpgradeTest0_0_9_22to0_0_9_23()
{
    // NOTE: Existing databases will lose all Attribute records.
    // They will need to be re-entered by hand as Events.
    char* query =
        "BEGIN;\n"
        "DELETE FROM ReferenceEntity WHERE entity_type=6;\n"
        "DROP TABLE Attribute;\n"
        "DROP TABLE AttributeType;\n"
        "DROP TABLE LinkAttribute;\n"
        "UPDATE Version SET test=23 WHERE id=1;\n"
        "COMMIT;\n"
    ;
    recDb::GetDb()->ExecuteUpdate( query );
}

static void UpgradeTest0_0_9_23to0_0_9_25()
{
...
static void UpgradeRev0_0_9toCurrent( int test )
{
    ...
    case 23:
    case 24: UpgradeTest0_0_9_23to0_0_9_25();
    }
}
