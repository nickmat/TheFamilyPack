...
fbRgEditGallery::fbRgEditGallery( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	this->Connect( m_opAddNewMedia->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( fbRgEditGallery::OnAddNewMedia ) );
	this->Connect( m_opAddExistingMedia->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( fbRgEditGallery::OnAddExistingMedia ) );
...
fbRgEditGallery::~fbRgEditGallery()
{
	...
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( fbRgEditGallery::OnAddNewMedia ) );
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( fbRgEditGallery::OnAddExistingMedia ) );
