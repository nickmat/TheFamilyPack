...
fbRgEditReference::fbRgEditReference( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	fgSizer20->Add( m_textCtrlTitle, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND|wxTOP|wxBOTTOM|wxRIGHT, 5 );

	m_buttonHigherRef = new wxButton( this, wxID_ANY, _("&Higher Ref:"), wxDefaultPosition, wxDefaultSize, wxBU_RIGHT );
	fgSizer20->Add( m_buttonHigherRef, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	m_textCtrlHigherRef = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY );
	fgSizer20->Add( m_textCtrlHigherRef, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND|wxBOTTOM|wxRIGHT, 5 );

	m_buttonResearcher = new wxButton( this, wxID_ANY, _("&Researcher:"), wxDefaultPosition, wxDefaultSize, wxBU_RIGHT );
	fgSizer20->Add( m_buttonResearcher, 0, wxBOTTOM|wxRIGHT|wxLEFT|wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT, 5 );

	wxBoxSizer* bSizer20;
	bSizer20 = new wxBoxSizer( wxHORIZONTAL );

	m_textCtrlResearcher = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY );
	bSizer20->Add( m_textCtrlResearcher, 1, wxBOTTOM|wxRIGHT|wxALIGN_CENTER_VERTICAL, 5 );

	wxStaticText* m_staticText5;
	m_staticText5 = new wxStaticText( this, wxID_ANY, _("User Re&f:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText5->Wrap( -1 );
	bSizer20->Add( m_staticText5, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	m_textCtrlUserRef = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer20->Add( m_textCtrlUserRef, 1, wxBOTTOM|wxRIGHT|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer21->Add( m_textCtrlUid, 1, wxBOTTOM|wxRIGHT|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_notebookBottom->AddPage( m_panelCitation, _("&1 Citation"), false );
	...
	m_notebookBottom->AddPage( m_panelMedia, _("&2 Media"), false );
	...
	m_notebookBottom->AddPage( m_panelPersona, _("&3 Persona"), false );
	...
	m_notebookBottom->AddPage( m_panelEventa, _("&4 Eventa"), false );
	...
	m_notebookBottom->AddPage( m_panelEntities, _("&5 Entities"), true );
	...
	// Connect Events
	m_buttonHigherRef->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( fbRgEditReference::OnButtonHigherRef ), NULL, this );
	m_buttonResearcher->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( fbRgEditReference::OnButtonResearcher ), NULL, this );
	...
	m_listCitation->Connect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnCitationDeselect ), NULL, this );
	m_listCitation->Connect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnCitationSelect ), NULL, this );
	...
	m_listMedia->Connect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnMediaDeselect ), NULL, this );
	m_listMedia->Connect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnMediaSelect ), NULL, this );
	...
	m_listPersona->Connect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnPersonaDeselect ), NULL, this );
	m_listPersona->Connect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnPersonaSelect ), NULL, this );
	...
	m_listEventa->Connect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnEventaDeselect ), NULL, this );
	m_listEventa->Connect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnEventaSelect ), NULL, this );
	...
	m_listEntities->Connect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnEntityDeselect ), NULL, this );
	m_listEntities->Connect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnEntitySelect ), NULL, this );
...
{
	// Disconnect Events
	m_buttonHigherRef->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( fbRgEditReference::OnButtonHigherRef ), NULL, this );
	m_buttonResearcher->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( fbRgEditReference::OnButtonResearcher ), NULL, this );
	...
	m_listCitation->Disconnect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnCitationDeselect ), NULL, this );
	m_listCitation->Disconnect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnCitationSelect ), NULL, this );
	...
	m_listMedia->Disconnect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnMediaDeselect ), NULL, this );
	m_listMedia->Disconnect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnMediaSelect ), NULL, this );
	...
	m_listPersona->Disconnect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnPersonaDeselect ), NULL, this );
	m_listPersona->Disconnect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnPersonaSelect ), NULL, this );
	...
	m_listEventa->Disconnect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnEventaDeselect ), NULL, this );
	m_listEventa->Disconnect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnEventaSelect ), NULL, this );
	...
	m_listEntities->Disconnect( wxEVT_COMMAND_LIST_ITEM_DESELECTED, wxListEventHandler( fbRgEditReference::OnEntityDeselect ), NULL, this );
	m_listEntities->Disconnect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( fbRgEditReference::OnEntitySelect ), NULL, this );
